      ...
      <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="https://via.placeholder.com/1920x600?text=Matrimony+App" className="d-block w-100" alt="Matrimony Image 1" />
          ...
          <div className="carousel-item">
            <img src="https://via.placeholder.com/1920x600?text=Matrimony+App+Image+2" className="d-block w-100" alt="Matrimony Image 2" />
            <div className="carousel-caption d-none d-md-block">
          ...
          <div className="carousel-item">
            <img src="https://via.placeholder.com/1920x600?text=Matrimony+App+Image+3" className="d-block w-100" alt="Matrimony Image 3" />
            <div className="carousel-caption d-none d-md-block">
